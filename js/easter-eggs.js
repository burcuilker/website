    ...
    const specialDays = [
        { day: 4, month: 12, baseYear: 2022, message: "hayatımın en güzel yolculuğu başladı. Yıl dönümümüz kutlu olsun aşkım ❤️", emojis: ["💖", "❤️", "🌹", "💞"] },
        { day: 31, month: 12, message: "Yeni bir yıla yine seninle girmek… bundan güzel bir başlangıç olabilir mi? ❤️", emojis: ["🎄", "❄️", "🎁"] },
        { day: 12, month: 1, message: "Bugün senin günün, iyi ki doğdun hayatımın en güzel parçası ❤️", emojis: ["🎂", "🎉", "💐", "🎈", "❤️"] },
        { day: 14, month: 2, message: "Sevgililer Günümüz kutlu olsun, seni seviyorum ❤️", emojis: ["💞", "❤️", "🌹", "💘"] },
        { day: 8, month: 3, message: "Tüm güzelliğiyle hayatıma anlam katan kadına... Kadınlar Günün kutlu olsun ❤️", emojis: ["🌷", "🌸", "🌺", "💖"] }
    ];
